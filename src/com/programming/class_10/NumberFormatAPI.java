...
public class NumberFormatAPI {
	...
	public static void main(String[] args) {
		...
		System.out.println("Number Format using Italy Locale is" + usingItalianCurrency.format(number));
		...
		System.out.println("Date Format using germany Locale is" + germanDF.format(1234));
